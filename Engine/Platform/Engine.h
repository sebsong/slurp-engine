...
static const std::unordered_map<SDL_Keycode, slurp::KeyboardCode> KeyboardSDLCodeToSlurpCode =
{
    ...
    {SDLK_B, slurp::KeyboardCode::B},
    {SDLK_C, slurp::KeyboardCode::C},
    {SDLK_D, slurp::KeyboardCode::D},
    {SDLK_E, slurp::KeyboardCode::E},
    {SDLK_F, slurp::KeyboardCode::F},
    {SDLK_G, slurp::KeyboardCode::G},
    {SDLK_H, slurp::KeyboardCode::H},
    {SDLK_I, slurp::KeyboardCode::I},
    {SDLK_J, slurp::KeyboardCode::J},
    {SDLK_K, slurp::KeyboardCode::K},
    {SDLK_L, slurp::KeyboardCode::L},
    {SDLK_M, slurp::KeyboardCode::M},
    {SDLK_N, slurp::KeyboardCode::N},
    {SDLK_O, slurp::KeyboardCode::O},
    {SDLK_P, slurp::KeyboardCode::P},
    {SDLK_Q, slurp::KeyboardCode::Q},
    {SDLK_R, slurp::KeyboardCode::R},
    {SDLK_S, slurp::KeyboardCode::S},
    {SDLK_T, slurp::KeyboardCode::T},
    {SDLK_U, slurp::KeyboardCode::U},
    {SDLK_V, slurp::KeyboardCode::V},
    {SDLK_W, slurp::KeyboardCode::W},
    {SDLK_X, slurp::KeyboardCode::X},
    {SDLK_Y, slurp::KeyboardCode::Y},
    {SDLK_Z, slurp::KeyboardCode::Z},
    ...
    {SDLK_RIGHT, slurp::KeyboardCode::RIGHT_ARROW},
    {SDLK_UP, slurp::KeyboardCode::UP_ARROW},
    {SDLK_DOWN, slurp::KeyboardCode::DOWN_ARROW},
