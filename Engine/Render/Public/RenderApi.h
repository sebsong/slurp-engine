...
namespace render {
    ...
    static constexpr uint32_t POSITION_ATTRIBUTE_SIZE = sizeof(Vertex::position);
    static constexpr uint32_t TEXTURE_COORD_ATTRIBUTE_SIZE = sizeof(Vertex::textureCoord);
    static constexpr uint32_t VERTEX_SIZE = POSITION_ATTRIBUTE_SIZE + TEXTURE_COORD_ATTRIBUTE_SIZE;
...
#define RENDER_GEN_ARRAY_BUFFER(fnName) render::vertex_array_id fnName(const render::Vertex vertexArray[], int vertexCount)
