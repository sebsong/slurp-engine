...
namespace player {
    ...
    void Player::handleMouseAndKeyboardInput(
        ...
        if (mouseState.justPressed(slurp::MouseCode::LeftClick)) {
            projectile::Projectile& projectile = game::State->projectiles[game::State->
                projectileIdx];
    ...
    void Player::activateParry() {
        ...
        this->renderInfo.sprite = game::Assets->playerParrySprite;
    ...
    void Player::deactivateParry() {
        ...
        this->renderInfo.sprite = game::Assets->playerSprite;
    }
}
