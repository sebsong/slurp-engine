...
namespace update
{
    ...
    static slurp::Vector2<int> getPositionUpdate(slurp::Vector2<int> currentPosition, slurp::Vector2<int> targetPositionUpdate,
                                          slurp::Tilemap tilemap)
    {
        ...
        {
            render::ColorPaletteIdx targetXAxisTilemapValue = tilemap.map[currentTilemapPosition.y][targetTilemapPosition.x];
            ...
            render::ColorPaletteIdx targetYAxisTilemapValue = tilemap.map[targetTilemapPosition.y][currentTilemapPosition.x];
